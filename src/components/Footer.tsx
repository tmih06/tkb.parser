    ...
    return (
        <Flex justify="center" align="center" direction="column" style={{ margin: '2rem 0' }} gap="4">
            ...
            <Text size="1" color="gray" style={{ textAlign: 'center' }}>
                <Link target="_blank" color="gray" href="https://github.com/michioxd/dut.tkb.parser">Mã nguồn trên GitHub</Link> - <Link target="_blank" color="gray" href="https://github.com/michioxd/dut.tkb.parser/blob/main/LICENSE">MIT License</Link>
                <br />
